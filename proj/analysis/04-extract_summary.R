...
########################################################
# data_out is only used past this
data_out <- 
  crossing(
...
# Save the data. ONLY DATA USED FOR THE REST OF THE SCRIPTS
save(data_out, file=file.path(RESULTS_DIR, paste0('results_', DATE,'.RData')))

save(data_out, file=file.path(paste0('results/2020-06-24/', 'results_', DATE,
                                     '.RData')))
